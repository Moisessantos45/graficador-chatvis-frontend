...
const AnalizarChats = ({ texto }) => {
  ...
  return (
    <article className="w-12/12 sm:w-1/2 h-8/12 flex-wrap bg-zinc-50 flex justify-center m-1 overflow-y-auto shadow-xl shadow-gray-300 rounded-lg hover:scale-100 transition-all">
